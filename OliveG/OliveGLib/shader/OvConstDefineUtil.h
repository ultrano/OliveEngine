...
#define CONST_DECL_FLOAT(type,name,regindex,count)
#define CONST_DECL_FLOAT_ARRAY(arraycount,type,name,regindex,count)
#define CONST_DECL_BOOL(name,regindex)
